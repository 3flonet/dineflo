...
<div class="min-h-screen bg-white dark:bg-gray-900 pb-24 lg:pb-0">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-8 relative -mt-20 sm:-mt-24 z-10 flex flex-col">
        ...
        {{-- Profile Header Card --}}
        <div class="bg-white dark:bg-gray-800 rounded-[2rem] p-6 sm:p-8 shadow-[0_8px_30px_rgb(0,0,0,0.06)] dark:shadow-none border border-gray-100 dark:border-white/5 mb-8 w-full flex-shrink-0">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6 overflow-visible">
            ...
            {{-- Contact & Address --}}
            <div class="bg-gray-50 dark:bg-gray-800/50 rounded-[2rem] p-6 border border-gray-100 dark:border-white/5 flex-shrink-0">
            ...
            <div class="mb-12">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    @foreach($feedbacks as $feedback)
                         <div class="bg-gray-50 dark:bg-gray-800/50 rounded-[2rem] p-6 border border-gray-100 dark:border-white/5 flex flex-col h-full hover:shadow-lg transition-shadow duration-300">
        ...
        @if($restaurant->google_map_embed)
             <div class="bg-gray-50 dark:bg-gray-800/50 rounded-[2rem] p-3 sm:p-4 border border-gray-100 dark:border-white/5 flex-shrink-0 mb-20 w-full overflow-hidden">
    ...
    <div class="fixed inset-0 z-[100] flex items-center justify-center p-4">
        <div class="absolute inset-0 bg-black/60 backdrop-blur-md" wire:click="$set('showQueueModal', false)"></div>
                <div class="relative bg-white dark:bg-gray-800 w-full max-w-lg rounded-[2.5rem] shadow-2xl overflow-hidden animate-[scaleUp_0.3s_ease-out]">
            ...
            <div class="p-8 sm:p-12 text-center">
                ...
                <div class="bg-gray-50 dark:bg-gray-900/50 rounded-[3rem] p-10 relative overflow-hidden group mb-10 border border-gray-100 dark:border-white/5 shadow-sm text-center">
